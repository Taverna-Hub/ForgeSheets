...
def save_sheet_in_campaign(name, race, role, image, strength, intelligence, wisdom, charisma, constitution, speed, healthPointMax, manaMax, exp, user_id, description, campaign_id):
    errors=[]
    ...
    sheet = Sheet(name = name, race = race, role = role, image = image, strength = strength, intelligence = intelligence, wisdom = wisdom, charisma = charisma, constitution = constitution, speed = speed, healthPointMax = healthPointMax, manaMax = manaMax, exp = exp1, expTotal = exp1, healthPoint = healthPointMax, mana = manaMax, user_id = user_id, description = description, campaign_id=campaign_id)
    sheet.save()
    sheet.updateXp()
    sheet.save()
    return sheet