...
//         cy.get('[style=""] > h2').invoke('text').should('have.string',"Darius") //NOME
//         cy.get('.sheet_info > :nth-child(1) > :nth-child(2)').invoke('text').should('have.string',"0 (4/100xp)") // XP
//         cy.get('.sheet_info > :nth-child(2) > :nth-child(2)').invoke('text').should('have.string',"Humano") // RAÇA
//         cy.get('.sheet_info > :nth-child(3) > :nth-child(2)').invoke('text').should('have.string',"Guerreiro") // CLASSE
//     })
...
//         cy.get('#submit_button').click()
//         cy.get('.sheetCard > :nth-child(1) > h2').last().invoke('text').should('have.string',"Ellie")
//         cy.get('.sheetCard > :nth-child(1) > .sheet_info > :nth-child(1) > :nth-child(2)').last().invoke('text').should('have.string',"3 (300/800xp)")
//         cy.get('.sheetCard > :nth-child(1) > .sheet_info > :nth-child(3) > :nth-child(2)').last().invoke('text').should('have.string',"Infiltradora")
//         cy.get('.sheetCard > :nth-child(1) > .sheet_info > :nth-child(2) > :nth-child(2)').last().invoke('text').should('have.string',"Humano")
//     })
