...
describe ('update sheet', () => {
    ...
    it ('submitting HP and Mana values higher than max', () => {
        ...
        cy.get('input[name="healthPointMax"]').should('have.value', "100")
        cy.get('input[name="healthPoint"]').should('have.value', "100")
        cy.get('input[name="manaMax"]').should('have.value', "100")
        cy.get('input[name="manaActual"]').should('have.value', "100")
